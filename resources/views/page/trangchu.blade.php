					    ...
					    <div class="banner" >
								...
								@foreach($slide as $sl)
									<li data-transition="boxfade" data-slotamount="20" class="active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0;">
										<div class="abc"  src="source/image/slide/{{$sl->image}}" data-src="source/image/slide/{{$sl->image}}" style="background-color: rgba(0, 0, 0, 0); background-repeat: no-repeat; background-image: url('source/image/slide/{{$sl->image}}'); background-size: cover; background-position: center center; width: 100%; height: 100%; opacity: 1; visibility: inherit;"></div>	
						        	</li>
								<!-- <li data-transition="boxfade" data-slotamount="20" class="active-revslide" style="width: 100%; height: 100%; overflow: hidden; z-index: 18; visibility: hidden; opacity: 0;">
					...
					<div class="col-sm-12">
						<div class="beta-products-list">
							...
							<div class="beta-products-details">
								<p class="pull-left">{{count($new_product)}} sản phẩm mới.</p>
								...
								<div class="col-sm-3">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$new->id)}}"><img src="source/image/product/{{$new->image_products}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$new->name_products}}</p>
							...
							<center><div class="row">{{$new_product->links()}}</div></center>
						...
						<div class="beta-products-list">
							...
							@foreach($sanpham_khuyenmai as $spkm)
								<div class="col-sm-3">
									<div class="single-item">
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$spkm->id)}}"><img src="source/image/product/{{$spkm->image_products}}" alt=""height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$spkm->name_products}}</p>
											<p class="single-item-price">
												<span class="flash-del">{{number_format($spkm->unit_price)}}</span>
							...
							<center><div class="row">{{$sanpham_khuyenmai->links()}}</div></center>
						</div> <!-- .beta-products-list -->
					</div>
