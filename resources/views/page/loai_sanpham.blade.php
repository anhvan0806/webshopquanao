...
<div class="inner-header">
		<div class="container">
			<div class="pull-left">
				<h6 class="inner-title">Sản phẩm {{$loai_sp->name_products}}</h6>
			</div>
			...
			<div class="main-content">
				...
				<div class="row">
					<div class="col-sm-3">
						<ul class="aside-menu">
							@foreach($loai as $l)
							<li><a href="{{route('loaisanpham',$l->id_types)}}">{{$l->name}}</a></li>
							@endforeach
								...
								<div class="col-sm-4">
									<div class="single-item">
										...
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sp->id)}}"><img src="source/image/product/{{$sp->image_products}}" alt="" height="250px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$sp->name_products}}</p>
							...
							@foreach($sp_khac as $sp_k)
								<div class="col-sm-4">
									<div class="single-item">
										...
										@endif -->
										<div class="single-item-header">
											<a href="product.html"><img src="source/image/product/{{$sp_k->image_products}}" alt="" height="300px"></a>
										</div>
										<div class="single-item-body">
											<p class="single-item-title">{{$sp_k->name_products}}</p>
											<p class="single-item-price" style="font-size:18px">
											@if($sp_k->promotion_price!=0)
